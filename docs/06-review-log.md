...
| review-002-api | API | Open | Re-reviewed `feature/session-progress-api` on 2026-05-18. Blocking fixed locally; live DB session happy-path smoke remains pending on T-102. Full step API review still needed after T-202. |
