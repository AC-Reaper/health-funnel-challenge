...
| review-009-security-hardening | Security hardening | Open | Reviewed `feature/security-hardening` at `d6e4c66`: typecheck, 202 tests, build, db:validate, diff-check, and Preview security smoke pass. No Blocking findings; 1 Important docs-proof mismatch and 1 Nice-to-have same-origin precision issue remain. |
