...
| review-002-api | API | Open | Interim review of `feature/session-progress-api` on 2026-05-18. 1 Blocking, 4 Important, 3 Nice-to-have. Full step API review still needed after T-202. |
